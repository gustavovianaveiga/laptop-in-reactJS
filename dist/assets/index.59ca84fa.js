...
function zd() {
    ...
    return Be("div", { className: "global", children: Ql("div", { className: "tamanho", children: [Ql("h1", { className: "f11", children: ["F11 for a better experience. ", Be("br", {}), " (fullscreen)"] }), Ql("div", { id: "laptop", children: [Be("div", { id: "tela", onClick: e, children: Be("img", { src: "./assets/iconReact.png", alt: 'reactIcone', id: "iconReact" }) }), Be("div", { className: "teclado" })] })] }) })
}
